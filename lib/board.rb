...
attr_reader :cells, :count
  ...
  def valid_placement?(given)
    column_exists?(given) && column_available?(given)
  end 
  ...
  def computer_consecutive_vertical(computer_choice)
    cells_avail = @cells.find_all do |k, v|
  ...
  def player_diagonal_win?(given)
    ...
    @cells["c1"] == "X" && @cells["d2"] == "X" && @cells["e3"] == "X" && @cells["f4"] == "X" ||
    @cells["c2"] == "X" && @cells["d3"] == "X" && @cells["e4"] == "X" && @cells["f5"] == "X" ||
    @cells["c3"] == "X" && @cells["d4"] == "X" && @cells["e5"] == "X" && @cells["f6"] == "X" ||   
  ...
  def computer_diagonal_win?(computer_choice)
    ...
    @cells["c1"] == "O" && @cells["d2"] == "O" && @cells["e3"] == "O" && @cells["f4"] == "O" ||
    @cells["c2"] == "O" && @cells["d3"] == "O" && @cells["e4"] == "O" && @cells["f5"] == "O" ||
    @cells["c3"] == "O" && @cells["d4"] == "O" && @cells["e5"] == "O" && @cells["f6"] == "O" ||   
    @cells["d1"] == "O" && @cells["e2"] == "O" && @cells["f3"] == "O" && @cells["g4"] == "O" ||
    @cells["d2"] == "O" && @cells["e3"] == "O" && @cells["f4"] == "O" && @cells["g5"] == "O" ||
    @cells["d3"] == "O" && @cells["e4"] == "O" && @cells["f5"] == "O" && @cells["g6"] == "O"
  end
end
